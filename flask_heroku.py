                ...
                if not id_:
                    ...
                    for id_ in messages:
                        if messages[id_][1]:  # is_photo
                            send_photo_public(
                                tag_message, messages[id_][0], public_group, messages[id_][2])
                            send_photo_public(
                                tag_message, messages[id_][0], channel, messages[id_][2])
                            write_message_accepted(
                                [tag_message, messages[id_][0], messages[id_][2]])
